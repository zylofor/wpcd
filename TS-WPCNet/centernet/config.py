...
def add_centernet_config(cfg):
    ...
    _C.MODEL.CENTERNET.PRE_NMS_TOPK_TRAIN = 4000
    _C.MODEL.CENTERNET.POST_NMS_TOPK_TRAIN = 4000
    _C.MODEL.CENTERNET.PRE_NMS_TOPK_TEST = 4000
    _C.MODEL.CENTERNET.POST_NMS_TOPK_TEST = 4000
