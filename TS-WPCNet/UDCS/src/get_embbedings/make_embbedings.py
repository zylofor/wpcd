...
data_to_class_dict = {
    ...
    "imagenet_50": ImageNetSubset(subset_file="/home/dell/jzy/lab315/jzy/PaperLearning/MyUbuntu/DeepDPM/src/get_embbedings/imagenet_subsets/imagenet_50.txt"),
    "imagenet_50_test": ImageNetSubset(subset_file="/home/dell/jzy/lab315/jzy/PaperLearning/MyUbuntu/DeepDPM/src/get_embbedings/imagenet_subsets/imagenet_50.txt", split='test'),
    "imagenet": ImageNet()
    }
