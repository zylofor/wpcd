...
def parse_minimal_args(parser):
    # Dataset parameters
    parser.add_argument("--dir", default="pretrained_embeddings/umap_embedded_datasets/WPCD", help="dataset directory")
    ...
    parser.add_argument(
        "--batch-size", type=int, default=512, help="input batch size for training"
    )
    parser.add_argument(
        "--seed",
        type=int,
...
def train_cluster_net():
    ...
    if args.save_checkpoints:
        ...
        checkpoint_callback = ModelCheckpoint(dirpath = f"/home/dell/jzy/lab315/jzy/PaperLearning/MyUbuntu/DeepDPM/saved_models/{args.dataset}/{args.exp_name}")
